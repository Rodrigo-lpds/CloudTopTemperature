...
plt.savefig('/home/cendas/Documents/VLAB/Output/South_America_Projections/G16_C' + str(Band) + '_' + date_saved + '_' + time_save + '.png', dpi=DPI, pad_inches=0, transparent=True)
plt.close()
...
with open('/home/cendas/Documents/VLAB/Output/South_America_Projections/G16_Log.txt', 'a') as log:
 log.write(path.replace('\\\\', '\\') + '\n')
#======================================================================================================

# Export the result to GeoTIFF
driver = gdal.GetDriverByName('GTiff')
driver.CreateCopy('/home/cendas/Documents/VLAB/Output/South_America_Projections/Channel_13.tif', grid, 0)
#======================================================================================================
