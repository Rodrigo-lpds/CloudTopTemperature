...
plt.savefig('/home/cendas/GOES16_WS_Rodrigo/CloudTopTemperature/Output/RJ/Projections/CH'+str(Band)+'/RJ_G16_C' + str(Band) + '_' + date + '_' + time_saved + ' UTC.tif', dpi=DPI, pad_inches=0, transparent=True)
plt.close()
