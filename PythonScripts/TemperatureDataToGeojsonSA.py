...
my_file = Path("/home/cendas/GOES16-Files/Output/South_America/GeoJsonTemperature/"+ date + '_' + time_saved + ".geojson")
if my_file.is_file() or int(Band) != 13: 
    ...
    f = open("/home/cendas/GOES16-Files/Output/South_America/GeoJsonTemperature/"+date + '_' + time_saved + ".geojson", "w")
    f.write("{\n")
